...
Route::middleware(['auth'])->group(function () {
 ...
 Route::get('/chat/user/{userId}', [ChatController::class, 'chatWithUser'])->name('chat.show');
Route::post('/chat/user/{userId}/send', [ChatController::class, 'sendMessage'])->name('chat.send');
...
Route::middleware(['setData'])->group(function () {
    ...
    Route::get('/viewinvoice/', [SellPosController::class, 'viewshowInvoice'])->name('viewshow_invoice');
...
Route::middleware(['setData', 'auth', 'SetSessionData', 'language', 'timezone', 'AdminSidebarMenu', 'CheckUserLogin'])->group(function () {
    ...
    Route::get('/pending-shipments', [HomeController::class, 'pendingShipments'])->name('pending-shipments');
    Route::get('/product-stock-alert', [HomeController::class, 'productStockAlert'])->name('product-stock-alert');
    ...
    Route::get('taxonomies/designations-by-department', [TaxonomyController::class, 'getDesignationsByDepartment']);
    ...
    //
    Route::post('/products/stockupdate', [ProductController::class, 'stockupdate']);
    ...
    Route::get('/sells/sell_list', [SellController::class, 'getsell_list'])->name('sell_list');

    Route::get('/sells/descount_list', [SellController::class, 'descountlist'])->name('descount_list');
    Route::post('/sells/descount_list', [SellController::class, 'descountlist'])->name('descount_list');
    ...
    Route::get('/reports/customer-salse-report', [ReportController::class, 'getCustomer']);
    Route::get('/reports/customer-salse-reportd', [ReportController::class, 'getCustomerd']);
    Route::get('/reports/stock-report', [ReportController::class, 'getStockReport']);
    
Route::get('/reports/stock-report-product', [ReportController::class, 'getStockReportproduct'])->name('stockproductreport');
Route::post('/reports/stock-report-product', [ReportController::class, 'getStockReportproduct'])->name('stockproductreport');
Route::post('/updatepostatus', [ReportController::class, 'updatepostatus'])->name('updatepostatus');

Route::post('/reports/stock-report-product-pdf', [ReportController::class, 'getStockReportproductpdf'])->name('getStockReportproductpdf');
    ...
    Route::get('/reports/dead-products', [ReportController::class, 'getDeadProducts']);
    ...
    Route::resource('project-checklists', ProjectChecklistController::class);
    Route::post('project-checklists/{project_id}/add-task', [ProjectChecklistController::class, 'addTask'])->name('project-checklists.add-task');
    Route::post('project-tasks/{task_id}/update', [ProjectChecklistController::class, 'updateTask'])->name('project-tasks.update');
    Route::delete('project-tasks/{task_id}', [ProjectChecklistController::class, 'deleteTask'])->name('project-tasks.delete');
    Route::get('project-tasks', [ProjectChecklistController::class, 'tasksIndex'])->name('project-tasks.index');
    Route::post('project-tasks/{task_id}/comments', [ProjectChecklistController::class, 'storeComment'])->name('project-tasks.comments.store');
    Route::get('project-tasks/{task_id}/comments', [ProjectChecklistController::class, 'getComments'])->name('project-tasks.comments.index');
    Route::get('project-tasks/{task_id}/timeline', [ProjectChecklistController::class, 'getTimeline'])->name('project-tasks.timeline');
    Route::get('project-task-comments/{comment_id}/download', [ProjectChecklistController::class, 'downloadDocument'])->name('project-task-comments.download');
    Route::post('project-checklists/{project_id}/update-assigned-users', [ProjectChecklistController::class, 'updateAssignedUsers'])->name('project-checklists.update-assigned-users');
    ...
    Route::get('/product-costings', [ProductCostingController::class, 'index'])->name('product-costings.index');
    Route::get('/product-costings/create', [ProductCostingController::class, 'create'])->name('product-costings.create');
    Route::post('/product-costings', [ProductCostingController::class, 'store'])->name('product-costings.store');
    Route::delete('/delete-product-costings/{id}', [ProductCostingController::class, 'delete_casting'])->name('product-costings.delete');
    Route::get('/product-costings/{productCasting}', [ProductCostingController::class, 'show'])->name('product-costings.show');
    Route::get('/product-costings/{id}/edit', [ProductCostingController::class, 'edit'])->name('product-costings.edit');
    Route::put('/product-costings/{id}', [ProductCostingController::class, 'update'])->name('product-costings.update');
...
Route::middleware(['auth'])->group(function () {
    ...
    Route::get('/sells/downloadinv/{transaction_id}', [SellPosController::class, 'downloadinv']);
