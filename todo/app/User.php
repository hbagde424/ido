...
class User extends Authenticatable
{
     ...
     * @var array
     */
   protected $guarded = ['id']; // keep this
   // protected $fillable = ['password']; // add this line
...
protected $fillable = [
    ...
    {
        return $this->belongsTo(\App\Category::class, 'essentials_department_id')
...
{
    return $this->hasMany(\Modules\Essentials\Entities\ToDo::class, 'user_id');
}
    ...
    {
        return $this->belongsToMany(\App\ProjectChecklist::class, 'project_checklist_user');
    }
}
