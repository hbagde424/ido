...
class NotificationController extends Controller
{
 ...
 protected $firebaseService;
     ...
     * @return void
     */
    public function __construct(NotificationUtil $notificationUtil, TransactionUtil $transactionUtil,FirebaseService $firebaseService)
    {
  ...
  public function sendNotification(Request $request)
    {
        dd();
        $deviceToken = 'chWW61ELQeWMmSuYMJdi5Q:APA91bFvdQypoxEeh8odrROmUnTMLVOfmdYCbdnUZZFwC6Tn4tF-nim1M7m2W5b_O9uvUmUjp6A7cQmwQ-4BEKyignOws_lCjJeCzYwBWDDyisBUuglCJzxQUsXq-g_Cx6_4Vxi44ZDX';
        try {
            $this->firebaseService->sendNotification($deviceToken, 'Hello', 'This is a notification message.');
