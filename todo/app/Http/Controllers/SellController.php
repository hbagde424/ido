...
class SellController extends Controller
{
    ...
    public function show($id)
    {
     ...
     public function descountlist(Request $request)
     { 
            $startDate= $request->from_date;
            $endDate= $request->to_date;
            $locationid= $request->sell_list_filter_location_idnew;

 $tran = Transaction::where('type', 'sell')
    ->where('actual_discount', '!=', '0.0000')
    ...
    $returns = Transaction::whereNotNull('return_parent_id')
    ->pluck('return_parent_id')
    ->toArray();
    ...
    $business_id = request()->session()->get('user.business_id');
        ...
        $business_locations = BusinessLocation::forDropdown($business_id, false);
        return view('sell.descount_list',compact('tran','business_locations','returns'));
