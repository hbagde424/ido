...
//                             $sub->url(
//                                 action([\App\Http\Controllers\ProductCostingController::class, 'index']),
//                                 __('Product Costing'),
//                                 ['icon' => 'fa fas fa-plus-circle', 'active' => request()->segment(1) == 'product-costings' && request()->segment(2) == 'product-costings']
//                             );
//                         }
...
//             }
            ...
            if (auth()->user()->can('project_checklist.view') || auth()->user()->can('project_checklist.create')) {
                $menu->url(action([\App\Http\Controllers\ProjectChecklistController::class, 'index']), __('All Projects'), ['icon' => 'fa fas fa-check-square', 'active' => request()->segment(1) == 'project-checklists'])->order(46);
            }
            //Project Tasks
            if (auth()->user()->can('project_checklist.view') || auth()->user()->can('project_checklist.create')) {
                $menu->url(action([\App\Http\Controllers\ProjectChecklistController::class, 'tasksIndex']), __('Project Tasks'), ['icon' => 'fa fas fa-tasks', 'active' => request()->segment(1) == 'project-tasks'])->order(47);
            }
            // //Accounts dropdown
            ...
            //     || auth()->user()->can('stock_report.view') || auth()->user()->can('tax_report.view')|| auth()->user()->can('stock_reportproduct.view')
            //     || auth()->user()->can('trending_product_report.view') || auth()->user()->can('dead_product_report.view') ||auth()->user()->can('sales_representative.view') || auth()->user()->can('register_report.view')
            ...
            //                 );
            //                     $sub->url(
            //                     action([\App\Http\Controllers\ReportController::class, 'getCustomer']),
            //                   'Tranding Customer',
            //                     ['icon' => 'fa fas fa-users', 'active' => request()->segment(2) == 'customer-salse-report']
            //                 );
            //                  $sub->url(
            //                     action([\App\Http\Controllers\ReportController::class, 'getCustomerd']),
            //                   'Dead Customer',
            //                     ['icon' => 'fa fas fa-users', 'active' => request()->segment(2) == 'customer-salse-reportd']
            //                 );
            //             }
            //              if (auth()->user()->can('stock_reportproduct.view')) {
            //                 $sub->url(
            //                     action([\App\Http\Controllers\ReportController::class, 'getStockReportproduct']),
            //                     __('report.stock_reportproduct'),
            //                     ['icon' => 'fa fas fa-percent', 'active' => request()->segment(2) == 'stock-reportproduct']
            //                 );
            //             }
            ...
            //                 $sub->url(
            //                     action([\App\Http\Controllers\ReportController::class, 'getDeadProducts']),
            //                     __('report.dead_products'),
            //                     ['icon' => 'fa fas fa-chart-line', 'active' => request()->segment(2) == 'dead-products']
            //                 );
            //             }
            ...
            //                   $sub->url(
            //                     action([\App\Http\Controllers\SellController::class, 'descountlist']),
            //                     __('lang_v1.discount_payment_report'),
            //                     ['icon' => 'fa fas fa-search-dollar', 'active' => request()->segment(2) == 'descount_list']
            //                 );
            //             }
