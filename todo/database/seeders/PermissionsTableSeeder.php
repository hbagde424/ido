...
class PermissionsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        $data = [
            ...
            ['name' => 'stock_reportproduct.view'],
            ['name' => 'tax_report.view'],
            ['name' => 'trending_product_report.view'],
            ['name' => 'dead_product_report.view'],
            ...
            ['name' => 'project_checklist.view'],
            ['name' => 'project_checklist.create'],
            ['name' => 'project_checklist.update'],
            ['name' => 'project_checklist.delete'],
