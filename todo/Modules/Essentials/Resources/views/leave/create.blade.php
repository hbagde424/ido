    ...
    <div class="modal-body">
    	<div class="row">
    		...
    		<div class="form-group col-md-12">
	      	...
	      	<!-- Leave Quota Status -->
	      	<div class="form-group col-md-12" id="quota_status_container" style="display: none;">
	      		<div class="alert" id="quota_status_alert">
	      			<i class="fa fa-spinner fa-spin"></i> <span id="quota_status_text">Checking leave quota...</span>
	      		</div>
	      	</div>
