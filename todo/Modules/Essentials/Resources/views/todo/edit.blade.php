  ...
  <div class="modal-content">
    ...
    <div class="modal-body">
    	<div class="row">
			...
			<div class="col-md-12">
		        <div class="form-group">
					{!! Form::label('project_checklist_id', __('Project') . ':') !!}
					<div class="input-group">
						<span class="input-group-addon">
							<i class="fa fa-folder"></i>
						</span>
						{!! Form::select('project_checklist_id', $projects, $todo->project_checklist_id, ['class' => 'form-control select2', 'placeholder' => __('messages.please_select'), 'style' => 'width: 100%;']); !!}
					</div>
				</div>
			</div>
			@endif
