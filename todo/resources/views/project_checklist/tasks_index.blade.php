                            ...
                            <td>{{ $task->created_at->format('d/m/Y H:i') }}</td>
                                                        <td>
                                                                ...
                                                                @php
                                                                        ...
                                                                        elseif ($task->project && $task->project->project_lead_id == auth()->user()->id) {
                                                                                $canEdit = true;
                                                                        }
                                                                @endphp
            ...
            <form id="edit_task_form">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <div class="checkbox">
                            <label>
                                <input type="checkbox" name="status" id="edit_task_status" value="1" class="edit-task-status-checkbox"> @lang('Completed')
                            </label>
                        </div>
                    </div>
...
<script>
    $(document).ready(function() {
        ...
        $(document).on('click', '.edit-task', function(e) {
            ...
            // Store project_id for checkbox permission check
            $('#edit_task_form').data('project_id', projectId);
