                        ...
                        <td>{{ $history['type_label'] }}</td>
                            <td class="text-success">
                                @if ($history['quantity_change'] > 0)
                                        ...
                                        @if ($history['type_label'] == 'Opening Stock')
                                            +<span class="display_currency" data-is_quantity="true">{{ $history['quantity_change'] }}</span>
                                        @else
                                            +<span class="display_currency"
                            ...
                            <td class="text-danger">
                                ...
                                @else
                                    <span class="display_currency  text-danger"
                                        data-is_quantity="true">@if($history['quantity_change'] < 0) {{ $history['quantity_change'] }} @endif</span>
                                @endif
                            </td>
                        @if (!empty($common_settings['enable_secondary_unit']))
                            @if ($history['quantity_change'] > 0)
