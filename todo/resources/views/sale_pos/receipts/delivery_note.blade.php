...
<div class="row invoice-info">
	...
	<div class="col-md-6 invoice-col width-50 color-555">
		...
		@if(!empty($receipt_details->display_name))
			<p><span style="font-size:18px; font-weight:900; color:black;">
	...
	<div class="col-xs-12">
		...
		<table class="table table-bordered " style="border:1px solid black !important;">
			<thead style="border:1px solid black !important;">
				<tr style="background-color: #357ca5 !important; border:1px solid black !important; color: black !important; font-size: 14px !important" class="table-no-side-cell-border table-no-top-cell-border text-center">
					<td style="background-color: #357ca5 !important; border:1px solid black !important; color: black !important; width: 5% !important">#</td>
					
					<td style="background-color: #357ca5 !important;border:1px solid black !important; color: black !important; width: 65% !important">
						{{$receipt_details->table_product_label}}
					</td>
					
					<td style="background-color: #357ca5 !important;border:1px solid black !important; color: black !important; width: 30% !important;">
			...
			<tbody style="border:1px solid black !important;">
				@foreach($receipt_details->lines as $line)
					<tr style="border:1px solid black !important;">
						...
						<td style="word-break: break-all;border:1px solid black !important;" >
