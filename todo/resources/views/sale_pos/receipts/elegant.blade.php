...
<div class="row  mt-5">
	<div class="col-xs-12">
		<table class="table table-bordered table-no-top-cell-border table-slim mb-12">
			<thead>
				<tr style="background-color: #357ca5 !important; color: Black !important; font-size: 15px !important" class="table-no-side-cell-border table-no-top-cell-border text-center">
					<td style="background-color: #357ca5 !important; color: Black !important; width: 5% !important">Sr.No.</td>
...
<div class="border-bottom col-md-12">
    	@if(!empty($receipt_details->total_in_words))
								...
								<h3>Arrested this invoice at the sum of- {{$receipt_details->total_in_words}}</small>
							@endif</div>
<!--<div class="border-bottom col-md-12">-->
