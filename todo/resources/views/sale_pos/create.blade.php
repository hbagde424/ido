...
@section('content')
<section class="content no-print" style="background:#8ca765;">
	...
	<div class="row mb-12">
		<div class="col-md-12">
			<div class="row">
				...
				<div class="col-md-5 no-padding" style="display:none;">
...
<script>
    $(document).ready(function() {
        $('#transactionSelect').on('change', function() {
            ...
            var url = '{{ url("payments/pay-contact-due/") }}'+'/'+transactionId;
            ...
            $.ajax({
                ...
                success: function(response) {
                      ...
                      $('.pay_contact_due_modal').html(response);
            $('.pay_contact_due_modal').modal('show');
