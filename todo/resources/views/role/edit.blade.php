    ...
    @component('components.widget', ['class' => 'box-primary'])
        ...
        <div class="col-md-9">
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'project_checklist.view', in_array('project_checklist.view', $role_permissions), 
                [ 'class' => 'input-icheck']); !!} View project checklists
              </label>
            </div>
          </div>
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'project_checklist.create', in_array('project_checklist.create', $role_permissions), 
                [ 'class' => 'input-icheck']); !!} Create project checklists
              </label>
            </div>
          </div>
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'project_checklist.update', in_array('project_checklist.update', $role_permissions), 
                [ 'class' => 'input-icheck']); !!} Update project checklists
              </label>
            </div>
          </div>
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'project_checklist.delete', in_array('project_checklist.delete', $role_permissions), 
                [ 'class' => 'input-icheck']); !!} Delete project checklists
              </label>
            </div>
          </div>
        </div>
        ...
        <div class="col-md-9">
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'essentials.crud_policy', in_array('essentials.crud_policy', $role_permissions), 
                [ 'class' => 'input-icheck']); !!} Manage Policies
              </label>
            </div>
          </div>
        </div>
      ...
      <hr>
        ...
        @endif
          ...
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'stock_reportproduct.view', in_array('stock_reportproduct.view', $role_permissions), 
                [ 'class' => 'input-icheck']); !!} {{ __( 'role.stock_reportproduct.view' ) }}
              </label>
            </div>
          </div>
          <div class="col-md-12">
           ...
           <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'dead_product_report.view', in_array('dead_product_report.view', $role_permissions), 
                [ 'class' => 'input-icheck']); !!} {{ __( 'role.dead_product_report.view' ) }}
              </label>
            </div>
          </div>
