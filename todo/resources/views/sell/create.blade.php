		...
		<div class="col-md-12 col-sm-12">
			...
			@component('components.widget', ['class' => 'box-solid'])
				...
				<div class="form-group">
					...
					<input class="form-control  " placeholder="Sale commision" name="sale_commision" type="text" value="0.00" id="sale_commision" aria-invalid="false">
					</div>
				</div>
			</div>
			<div class="col-md-4">
			...
			@component('components.widget', ['class' => 'box-solid'])
			    ...
			    <div class="col-md-4 @if($sale_type == 'sales_order') hide @endif"><br>
					...
					<input type="text" name="actual_discount" id="total_discountnewdata" readonly>
