<div class="pos-tab-content">
    <div class="row">
        ...
        <div class="col-sm-4">
         ...
         <div class="col-sm-4">
            <div class="form-group">
                {!! Form::label('custom_payment_8_label', __('lang_v1.custom_payment', ['number' => 8])); !!}
                {!! Form::text('custom_labels[payments][custom_pay_8]', !empty($custom_labels['payments']['custom_pay_8']) ? $custom_labels['payments']['custom_pay_8'] : null,
                ['class' => 'form-control', 'id' => 'custom_payment_8']); !!}
            </div>
        </div>
         <div class="col-sm-4">
            <div class="form-group">
                {!! Form::label('custom_payment_9_label', __('lang_v1.custom_payment', ['number' => 9])); !!}
                {!! Form::text('custom_labels[payments][custom_pay_9]', !empty($custom_labels['payments']['custom_pay_9']) ? $custom_labels['payments']['custom_pay_9'] : null,
                ['class' => 'form-control', 'id' => 'custom_payment_9']); !!}
            </div>
        </div>
         <div class="col-sm-4">
            <div class="form-group">
                {!! Form::label('custom_payment_10_label', __('lang_v1.custom_payment', ['number' => 10])); !!}
                {!! Form::text('custom_labels[payments][custom_pay_10]', !empty($custom_labels['payments']['custom_pay_10']) ? $custom_labels['payments']['custom_pay_10'] : null,
