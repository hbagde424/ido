  ...
  @endphp
    ...
    <div class="modal-body">
      ...
      <div class="row">
        ...
        <div class="col-md-4">
            <div class="form-group">
                {!! Form::label('user_location', __('business.business_location') . ':') !!}
                <div class="input-group">
                    <span class="input-group-addon">
                        <i class="fa fa-map-marker"></i>
                    </span>
                    {!! Form::select('user_location', $business_locations, $contact->location_id, ['class' => 'form-control', 'id' => 'user_location', 'placeholder' => __('messages.please_select')]); !!}
                </div>
            </div>
        </div>
