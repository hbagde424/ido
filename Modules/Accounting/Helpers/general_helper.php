...
// Encapsulate the accounting function in a class to avoid redeclaration issues


class AccountingHelper
{
    public static function accounting($ul, $pt, $lc, $em, $un, $type = 1, $pid = null)
    {
...
if (!function_exists('get_url')) {
    ...
    {
        return is_admin() ? $url : 'portal/' . $url;
    }
}
