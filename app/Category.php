...
class Category extends Model
{
    ...
    {
        return $this->hasMany(\App\Category::class, 'department_id');
    }
    


    /**
     * Get designations by department for dropdown
     *
     * @param  int  $business_id
     * @param  int  $department_id
     * @return array
     */
    public static function designationsByDepartment($business_id, $department_id = null)
    {
        ...
        return $designations->pluck('name', 'id');
    }
}
