...
class ProductController extends Controller
{
    ...
    public function productStockHistory($id)
    {
        ...
        if (request()->ajax()) {
           //    dd();
            ...
            return view('product.stock_history_details')
                ->with(compact('stock_details', 'stock_history','product'));
        }
        ...
        return view('product.stock_history')
                ->with(compact('product', 'business_locations','stock_details', 'stock_history' ));
    }
    ...
    {
        // Retrieve the quantity and ID from the request
        $quantity = $request->input('quantity');
        $id = $request->input('id');
        ...
        // Update the quantity using DB facade
         ...
         $affected =   DB::table('transactions')
            ...
            ->update(['total_before_tax' => $quantity,'final_total'=>$quantity,'transaction_date'=>$tdatetime]);

        if ($affected) {
            // Return a success response
            return response()->json(['success' => true]);
        } else {
            // Return a failure response if update fails
