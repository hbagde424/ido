        ...
        <table class="table table-striped">
            ...
            <tr>
                ...
                <td >
                    ...
                    <input type="hidden" id="aaaaaaa" value="{{$data['total_expense_1']}}">
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>
                    <span class="display_currency" data-currency_symbol="true">{{$data['total_sell_discount']}}</span>
                                        <input type="hidden" id="total_sell_discount_val" value="{{$data['total_sell_discount']}}">
        ...
        <table class="table table-striped">
            ...
            <tr>
                ...
                <td>
                    ...
                    <input type="hidden" id="total_sell_shipping_charge_val" value="{{$data['total_sell_shipping_charge']}}">
...
<div class="col-xs-12">
    @component('components.widget')
        ...
        <h3 class="text-muted mb-0 hide" >
            {{ __('report.net_profit') }}: 
            <span class="display_currency" data-currency_symbol="true">{{$data['net_profit']}}</span>
        </h3>
        <small class="help-block hide">@lang('lang_v1.gross_profit') + (@lang('lang_v1.total_sell_shipping_charge') + @lang('lang_v1.sell_additional_expense') + @lang('report.total_stock_recovered') + @lang('lang_v1.total_purchase_discount') + @lang('lang_v1.total_sell_round_off') 
        @foreach($data['right_side_module_data'] as $module_data)
