...
<section class="content no-print">
     ...
     @component('components.filters', ['title' => __('report.filters')])
        @include('sell.partials.sellfilter')
        @if(!empty($sources))
            <div class="col-md-3">
            ...
            <table class="table table-bordered table-striped ajax_view" id="sell_table">
                <thead>
                    <tr>
                        ...
                        <!--<th>1{{ $custom_labels['types_of_service']['custom_field_1'] ?? __('lang_v1.service_custom_field_1' )}}</th>-->
                        <!--<th>2{{ $custom_labels['sell']['custom_field_1'] ?? '' }}</th>-->
                        <!--<th>1{{ $custom_labels['sell']['custom_field_2'] ?? ''}}</th>-->
                        <!--<th>2 {{ $custom_labels['sell']['custom_field_3'] ?? ''}}</th>-->
                        <!--<th>3 {{ $custom_labels['sell']['custom_field_4'] ?? ''}}</th>-->
                        <th> @lang('lang_v1.added_by')</th>
                        <th> @lang('sale.sell_note')</th>
                        <!--<th>6 @lang('sale.staff_note')</th>-->
                        <!--<th>7 @lang('sale.shipping_details')</th>-->
...
<script>
        ...
        $(document).ready(function() {
            var newTitle = "Sell Report"; // Set your new title here
            $('title').text(newTitle);
        });
    </script>
