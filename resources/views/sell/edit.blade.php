...
<input type="hidden" id="item_addition_method" value="{{$business_details->item_addition_method}}">
	...
	<div class="row">
		<div class="col-md-12 col-sm-12">
			...
			<div class="col-md-4">
				<div class="form-group">
					<label for="sale_commision">Sale commision </label>
					<div class="input-group">
					<span class="input-group-addon">
				 
					</span>
					<input class="form-control  " placeholder="Sale commision" name="sale_commision"
					type="text" value="{{ $transaction->sale_commision }}" id="sale_commision" aria-invalid="false">
					</div>
				</div>
			</div><div class="col-md-4">
				<div class="form-group">
					<label for="shipping_charges">Commision status</label>
					<div class="input-group">
					<span class="input-group-addon">
				 
					</span>
				 	
						<select class="form-control  " placeholder="commision status" name="commision_status"
				  id="commision_status" aria-invalid="false">
					    <option>Select Status</option>
					    <option  <?php if($transaction->commision_status=='Paid'){echo "selected";}  ?> value="Paid">Paid</option>
					    <option <?php if($transaction->commision_status=='Unpaid'){echo "selected";}  ?> value="Unpaid">Unpaid</option>
					    </select>
