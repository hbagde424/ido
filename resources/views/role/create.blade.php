    ...
    @component('components.widget', ['class' => 'box-primary'])
        ...
        <div class="col-md-9">
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'project_checklist.view', false,
          ...
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'project_checklist.create', false,
          ...
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'project_checklist.update', false,
          ...
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'project_checklist.delete', false,
        ...
        <div class="col-md-9">
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'essentials.crud_policy', false, 
        ...
        <div class="col-md-9">
          ...
          <div class="col-md-12">
           ...
           <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'stock_reportproduct.view', false, 
          ...
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'dead_product_report.view', false, 
