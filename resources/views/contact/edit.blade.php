  ...
  @endphp
    ...
    <div class="modal-body">
      ...
      <div class="row">
        ...
        <div class="col-md-4">
                    <div class="form-group">
                      	  <select class="form-control input-sm-6" name="user_location" id="user_location">
    		     <?php foreach($business_locations as $key=> $each_lovation) {?>
    		     <option <?php if($key==$contact->location_id){echo "selected";} ?> value="<?php echo $key ?>"><?php echo $each_lovation ?></option>
    		     <?php }?>
    		 </select>
